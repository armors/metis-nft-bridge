...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        // This method relies on extcodesize, which returns 0 for BXH in
     ...
     * of certain opcodes, possibly making BXH go over the 2300 gas limit
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     *
     * To learn more about hooks, head to xref:ROOT:extending-BXH.adoc#using-hooks[Using Hooks].
     */
